    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <View style={{ flex: 1, alignItems: "center",justifyContent: 'center', padding: 20 }}>
                <Image source={{ uri: student.ph53550_image }} style={{ width: 150, height: 150, borderRadius: 10 }} />
                <Text style={{ fontSize: 20, fontWeight: "bold", marginVertical: 10 }}>{student.ph53550_name}</Text>
                <Text style={{ fontSize: 16 }}>Mã SV: {student.ph53550_ma}</Text>
                <Text style={{ fontSize: 16 }}>Điểm TB: {student.ph53550_diemTB}</Text>
