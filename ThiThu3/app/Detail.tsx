...
return (
    <SafeAreaView style={{flex: 1}}>
        <View style={{ flex: 1, alignItems: "center",justifyContent: 'center', padding: 20 }}>
            <Image source={{ uri: student.thithu3_image }} style={{ width: 150, height: 150, borderRadius: 10 }} />
            <Text style={{ fontSize: 20, fontWeight: "bold", marginVertical: 10 }}>{student.thithu3_name}</Text>
            <Text style={{ fontSize: 16 }}>Tuổi: {student.thithu3_age}</Text>
